 ...
 * 
 * Usage : node scripts/seedPrimera.js
 *         node scripts/seedPrimera.js --reset (supprime tout avant)
 *         node scripts/seedPrimera.js --categories-only (categories seulement)
 *         node scripts/seedPrimera.js --full-reset (vide completement la base)
 * 
 * @module seed
 */
